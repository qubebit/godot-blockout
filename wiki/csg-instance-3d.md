...
3. Make your changes to the CSG source. Exiting edit mode automatically updates the runtime mesh while retaining the source objects.
4. Turn on **Generate Collision** when the baked geometry needs collision in-game.

The baked mesh includes UV2 coordinates for lightmapping. Use **Lightmap Texel Size** to control the lightmap detail.
